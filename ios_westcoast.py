...
station_nodes = [i for i in N.nodes if N.nodes[i]['charger_rate'] > 0]
...
instance = Instance_v2.Instance(N, parameters, ['heuristic'])
while True:
    try:
